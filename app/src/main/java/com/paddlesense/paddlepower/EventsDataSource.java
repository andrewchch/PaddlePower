...
public class EventsDataSource {
  ...
  public Event createEvent(int session, long time, int eventData) {
    ...
    long insertId = database.insert(BLESQLLiteHelper.TABLE_PPLOG, null,
        values);
    Cursor cursor = database.query(BLESQLLiteHelper.TABLE_PPLOG,
  ...
  public void deleteEvent(Event event) {
    ...
    database.delete(BLESQLLiteHelper.TABLE_PPLOG, BLESQLLiteHelper.COLUMN_ID
        + " = " + id, null);
  }
